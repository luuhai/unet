...
def deep_unet(pretrained_weights = None,input_size = (512,512,1)):
    ...
    conv3 = Conv2D(32, 3, padding = 'same', kernel_initializer = 'he_normal')(conv3)
    conv3 = LeakyReLU()(conv3)
    ...
    conv6 = Conv2D(32, 3, padding = 'same', kernel_initializer = 'he_normal')(conv6)
    conv6 = LeakyReLU()(conv6)
    plus6 = add([pool5, conv6])
    # drop4 = Dropout(0.5)(conv4)
    pool6 = MaxPooling2D(pool_size=(2, 2))(plus6)

    conv7 = Conv2D(64, 3, padding = 'same', kernel_initializer = 'he_normal')(pool6)
    conv7 = LeakyReLU()(conv7)
    conv7 = Conv2D(32, 3, padding = 'same', kernel_initializer = 'he_normal')(conv7)
    conv7 = LeakyReLU()(conv7)
    drop7 = Dropout(0.5)(conv7)

    up8 = Conv2D(32, 2, padding = 'same', kernel_initializer = 'he_normal')(UpSampling2D(size = (2,2))(drop7))
    up8 = LeakyReLU()(up8)
    ...
    up10 = Conv2D(32, 2, padding = 'same', kernel_initializer = 'he_normal')(UpSampling2D(size = (2,2))(conv9))
    up10 = LeakyReLU()(up10)
    ...
    conv10 = Conv2D(32, 3, padding = 'same', kernel_initializer = 'he_normal')(conv10)
    conv10 = LeakyReLU()(conv10)

    up11 = Conv2D(32, 2, padding = 'same', kernel_initializer = 'he_normal')(UpSampling2D(size = (2,2))(conv10))
    up11 = LeakyReLU()(up11)
    merge11 = concatenate([plus3,up11], axis = 3)
    conv11 = Conv2D(64, 3, padding = 'same', kernel_initializer = 'he_normal')(merge11)
    conv11 = LeakyReLU()(conv11)
    conv11 = Conv2D(32, 3, padding = 'same', kernel_initializer = 'he_normal')(conv11)
    conv11 = LeakyReLU()(conv11)

    up12 = Conv2D(32, 2, padding = 'same', kernel_initializer = 'he_normal')(UpSampling2D(size = (2,2))(conv11))
    up12 = LeakyReLU()(up12)
    merge12 = concatenate([plus2,up12], axis = 3)
    conv12 = Conv2D(64, 3, padding = 'same', kernel_initializer = 'he_normal')(merge12)
    conv12 = LeakyReLU()(conv12)
    conv12 = Conv2D(32, 3, padding = 'same', kernel_initializer = 'he_normal')(conv12)
    conv12 = LeakyReLU()(conv12)

    up13 = Conv2D(32, 2, padding = 'same', kernel_initializer = 'he_normal')(UpSampling2D(size = (2,2))(conv12))
    up13 = LeakyReLU()(up13)
    merge13 = concatenate([conv1,up13], axis = 3)
    conv13 = Conv2D(64, 3, padding = 'same', kernel_initializer = 'he_normal')(merge13)
    conv13 = LeakyReLU()(conv13)
    conv13 = Conv2D(32, 3, padding = 'same', kernel_initializer = 'he_normal')(conv13)
    conv13 = LeakyReLU()(conv13)
