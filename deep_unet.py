...
def deep_unet(pretrained_weights = None,input_size = (512,512,1), n_features=64):
    ...
    conv7 = LeakyReLU()(conv7)
    plus7 = add([pool6, conv7])
    drop7 = Dropout(0.5)(plus7)

    up8 = UpSampling2D(size = (2,2))(drop7)
    conv8 = Conv2D(2*n_features, 3, padding = 'same', kernel_initializer = 'he_normal')(up8)
    conv8 = LeakyReLU()(up8)
    merge8 = concatenate([plus6,up8], axis = 3)
    conv8 = Conv2D(n_features, 3, padding = 'same', kernel_initializer = 'he_normal')(merge8)
    conv8 = LeakyReLU()(conv8)
    plus8 = add([up8, conv8])

    up9 = UpSampling2D(size = (2,2))(plus8)
    conv9 = Conv2D(2*n_features, 3, padding = 'same', kernel_initializer = 'he_normal')(up9)
    conv9 = LeakyReLU()(up9)
    merge9 = concatenate([plus5,up9], axis = 3)
    conv9 = Conv2D(n_features, 3, padding = 'same', kernel_initializer = 'he_normal')(merge9)
    ...
    conv10 = Conv2D(2*n_features, 3, padding = 'same', kernel_initializer = 'he_normal')(up10)
    conv10 = LeakyReLU()(up10)
    merge10 = concatenate([plus4,up10], axis = 3)
    conv10 = Conv2D(n_features, 3, padding = 'same', kernel_initializer = 'he_normal')(merge10)
    ...
    conv11 = Conv2D(2*n_features, 3, padding = 'same', kernel_initializer = 'he_normal')(up11)
    conv11 = LeakyReLU()(up11)
    merge11 = concatenate([plus3,up11], axis = 3)
    conv11 = Conv2D(n_features, 3, padding = 'same', kernel_initializer = 'he_normal')(merge11)
    ...
    conv12 = Conv2D(2*n_features, 3, padding = 'same', kernel_initializer = 'he_normal')(up12)
    conv12 = LeakyReLU()(up12)
    merge12 = concatenate([plus2,up12], axis = 3)
    conv12 = Conv2D(n_features, 3, padding = 'same', kernel_initializer = 'he_normal')(merge12)
    ...
    conv13 = Conv2D(2*n_features, 3, padding = 'same', kernel_initializer = 'he_normal')(up13)
    conv13 = LeakyReLU()(up13)
    merge13 = concatenate([conv1,up13], axis = 3)
    conv13 = Conv2D(n_features, 3, padding = 'same', kernel_initializer = 'he_normal')(merge13)
